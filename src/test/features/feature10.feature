@All
 ...
 And user clicks "SwitchChainButton" button on "feature10" page
 Scenario: Claim Thor
 And user clicks "AvalancheNetworkButton" button on "feature10" page
 ...
 When user mousehover clicks "CompoundallButton" button on "feature10" page
 When user mousehover clicks "CompoundAllButton" button on "feature10" page
 ...
 And user clicks "BinanceSmartChainButton" button on "feature10" page
