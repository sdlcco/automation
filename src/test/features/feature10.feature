@All
 ...
 And user clicks "MetamaskSwitchChainButton" button on "feature9" page
 Scenario: Claim Thor
 And user clicks "AvaxNetworkButton" button on "feature9" page
 Given user navigates to "https://app.thor.financial/farm"
 When user clicks "Claim" button on "feature9" page
 ...
 And user clicks "BinanceNetworkButton" button on "feature9" page
 ...
 Then user waits for "10" seconds
 When user clicks "FarmHarvestButton" button on "feature9" page
